...
// ---- 7. RESULT ----
s=pres.addSlide(); title(s,"Result: the augmented sim supports LOSO / classification",
  "Same k-NN LOSO classifier on augmented sim + measured phantoms (CNN full-config anchor: sim 99.5%)");
imgFit(s,"classify_grid.png",16.0/10.5,1.5,5.75);
